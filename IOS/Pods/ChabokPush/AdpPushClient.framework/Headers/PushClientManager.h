...
- (BOOL)publishBackground:(NSString*)eventName data:(NSDictionary*)data;
...
///  This method is for decreasing value to users' numerical attribute.
/// @param attributeName is NSString
-(void) decrementUserAttribute:(NSString *) attributeName;


///  This method is for decreasing value to users' numerical attribute.
/// @param attribute  name
/// @param value of attribute
-(void) decrementUserAttributeValue:(NSString *) attribute value:(double) value;

/// This method is for decreasing values to users' numerical attributes.
/// @param attributes name
-(void) decrementUserAttributes:(NSArray<NSString *> *_Nonnull) attributes;

/// This method is for decreasing values to users' numerical attributes.
/// @param attributes name with value
-(void) decrementUserAttributeValues:(NSDictionary<NSString *, NSNumber *> *_Nonnull) attributes;

/// This methof is for removing attribute name from user attributes
/// @param attributeKey to removed from attributes
-(void) unsetUserAttribute:(NSString *_Nonnull) attributeKey;

/// This methof is for removing attributes name from user attributes
/// @param attributes  names to removed from attributes
